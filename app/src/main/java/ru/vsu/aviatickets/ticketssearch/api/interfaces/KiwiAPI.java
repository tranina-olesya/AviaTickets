...
public interface KiwiAPI {
    ...
    Call<KiwiResponse> getTickets(@Query("fly_from") String flyFrom, @Query("fly_to") String flyTo, @Query("date_from") String dateFrom, @Query("date_to") String dateTo, @Query("flight_type") String flightType);
}
